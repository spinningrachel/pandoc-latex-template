...
\newcommand{\notestart}{%
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\columncolor{notecolor!20}\setlength{\parindent}{0pt}\setlength{\leftskip}{6pt}\setlength{\rightskip}{8pt}\fontsize{8pt}{10pt}\selectfont}p{0.63\textwidth}|}
  \hline
...
\newcommand{\importantstart}{%
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\columncolor{importantcolor!15}\setlength{\parindent}{0pt}\setlength{\leftskip}{6pt}\setlength{\rightskip}{8pt}\fontsize{8pt}{10pt}\selectfont}p{0.63\textwidth}|}
  \hline
...
\newcommand{\warningstart}{%
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\columncolor{warningcolor!17}\setlength{\parindent}{0pt}\setlength{\leftskip}{6pt}\setlength{\rightskip}{8pt}\fontsize{8pt}{10pt}\selectfont}p{0.63\textwidth}|}
  \hline
...
\newcommand{\tipstart}{%
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\columncolor{tipcolor!7}\setlength{\parindent}{0pt}\setlength{\leftskip}{6pt}\setlength{\rightskip}{8pt}\fontsize{8pt}{10pt}\selectfont}p{0.63\textwidth}|}
  \hline
...
\newcommand{\criticalstart}{%
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{1cm}|>{\columncolor{criticalcolor!15}\setlength{\parindent}{0pt}\setlength{\leftskip}{6pt}\setlength{\rightskip}{8pt}\fontsize{8pt}{10pt}\selectfont}p{0.63\textwidth}|}
  \hline
...
% Constrain code blocks to 85% of text width for better readability
\makeatletter
\@ifundefined{Shaded}{%
